// using Fanda2.ControlPages;
using Fanda2.Presets;
...
namespace Fanda2.Navigation
{
    ...
    public partial class NavigationRoot : UserControl
    {
        ...
        private static readonly ThreadLocal<NavigationRoot> _current = new ThreadLocal<NavigationRoot>();
    ...
    public class ControlPagesData : List<ControlInfoDataItem>
    {
        ...
        {
            AddPage(typeof(UnitsPage), "Units");
            AddPage(typeof(ProductCategoriesPage), "Product Categories");
